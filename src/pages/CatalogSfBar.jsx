...
export default function CatalogSfBar() {
    return(
...
const cards=[
    {
        img:        'https://pangkalmultikarya.com/assets/img/sf.png',
        head:       'SF BAR SERIES',
        head1:      '',
        paragraf:   'Our Architectural Products in Aluminum Bar Profiles',
        buttonHref: 'https://online.fliphtml5.com/imiiz/fvvg/',
