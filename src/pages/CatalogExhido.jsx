...
export default function CatalogExhido() {
    return(
...
const cards=[
    {
        img:        'https://pangkalmultikarya.com/assets/img/exhido.jpg',
        head:       'EXHIDO',
        head1:      '',
        paragraf:   'Excellent High Performance Entrance Door that Brings the New Beauty in Your House',
        buttonHref: 'https://online.fliphtml5.com/imiiz/cmfh/#p=H1',
